...
5) Интефейс IBriding bабстрактнsq класс ABriding, реализованные в классах Briding_OX, Briding_CX, Briding_PMX, каждый из которых реализует один из вариантов кроссовера.
