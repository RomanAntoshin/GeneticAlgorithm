...
{
    class Inbriding: AStrategy
    {
        public Inbriding(IBriding briding, double[,] data, Person[] Group) : base(briding, data, Group) { }
        ...
        public override void Iteration()
        {
            ...
            {
                int[] key = Levenshtein.DistanceMinInd(Distance);
