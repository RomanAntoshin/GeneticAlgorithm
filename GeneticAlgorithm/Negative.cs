...
{
    class Negative: AStrategy
    {
        public Negative(IBriding briding, double[,] data, Person[] Group): base(briding, data, Group) { }
        ...
        public override void Iteration()
        {
            ...
            IBriding briding = new Briding_CX();
            for (int i = 0; i < Group.Length - 1; i++)
            {
                AddChildren(Group[i], Group[Group.Length - 1 - i]);
            }
            GetMutation();
